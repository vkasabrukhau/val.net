...
const jobs = [
  ["2025", "DURHAM, NC", "Duke I3T Lab", "Undergraduate Researcher · XR", "RESEARCH", "Building mixed-reality experiences at the Intelligent Interactive Internet of Things Lab with Dr. Maria Gorlatova. The headsets are heavy; the ideas are not.", true, true],
  ["2025", "HARTFORD, CT", "Travelers", "EDP Software Engineer", "ENTERPRISE", "In-house tools for 34,000+ employees. AI pipelines on AWS Bedrock & Textract for 11,000 underwriters, Terraform + Lambda infrastructure, and API queries 30% faster than I found them. Pitched product ideas to CIOs and lived.", false, true],
  ["2025", "DURHAM, NC", "Duke Applied Machine Learning", "Developer · Exec Team", "CAMPUS", "Remodeling the member experience for 50+ builders — new web + mobile portal, prototyped in Figma, shipped on the MERN stack.", false, true],
  ["2024", "DURHAM, NC", "Nicholas Institute", "Researcher · Energy & History", "RESEARCH", "From translating Soviet energy literature to co-authoring an honors thesis on post-USSR engineers in Silicon Valley. Zotero and I are on a first-name basis.", false, true],
