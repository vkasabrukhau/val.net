...
const jobs = [
  { years: "2025", place: "DURHAM, NC", org: "Duke I3T Lab", role: "Undergraduate Researcher · XR", tag: "RESEARCH", blurb: "Co-authored No Guide, No Cheat — detecting smart glasses via AR optical signatures — with Dr. Maria Gorlatova’s group; Best Demo at ACM HotMobile 2026. Rewrote a robot arm’s ROS 2 stack to cut data-collection sessions from 15 minutes to 2, and built a streaming 3D reconstruction pipeline at 60 FPS. The headsets are heavy; the ideas are not.", current: true },
  { years: "2025", place: "HARTFORD, CT", org: "Travelers", role: "EDP Software Engineer", tag: "ENTERPRISE", blurb: "Pitched Contract QA Automation to senior leadership; now tech lead for a system serving 3,000+ underwriters. Agentic review pipelines on AWS Bedrock cut contract QA cost 60%+, migrated 4 production apps to AWS, and left API responses 30% faster than I found them.", current: true },
  { years: "2025", place: "DURHAM, NC", org: "Duke Applied Machine Learning", role: "Developer · Exec Team", tag: "CAMPUS", blurb: "Remodeled the member experience for 50+ builders — new web + mobile portal, prototyped in Figma, shipped on the MERN stack." },
